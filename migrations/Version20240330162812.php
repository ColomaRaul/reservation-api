...
final class Version20240330162812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("CREATE TABLE reservation (id UUID NOT NULL, hotel_id UUID, locator VARCHAR(20), room_number VARCHAR(20), check_in TIMESTAMP WITH TIME ZONE, check_out TIMESTAMP WITH TIME ZONE, guests jsonb not null default '[]'::jsonb, PRIMARY KEY (id))");
    }
